...
<nav class="navbar navbar-expand-lg colorido" role="navigation">
    ...
    <div id="corpo2" class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2"><h1><br><br><br>NOSSOS VALORES</h1></div>
            <div class="col-sm-1"></div>
            <div class="col-sm-7"><h5><br><br><br><br><br><br><br><br><br>Nossas redes, atuam em regiões de domínio da língua portuguesa e suas variações. O conteúdo é maleável à sua região específica. Temos um histórico de 3.000 alunos nos últimos 2 anos, e um índice de 96% de aprovação. Nossos métodos são didáticos e prezam o desenvolvimento individual de cada contratante.<br><br><br><br><br><br><br><br><br><br><br></h5></div>
            <div class="col-sm-1"></div>
        </div>
    </div>
    <br><br>
