        ...
        <div id="content">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="<?=site_url('public/materia/historia/descobrasil')?>">Descobrimento do Brasil</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?=site_url('public/materia/historia/feudalismo')?>">Feudalismo</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?=site_url('public/materia/historia/atualidades')?>">Atualidades</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div id="corpo" class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-1"></div>
                    <div class="col-sm-7"><h1><br><br><br>Descobrimento do Brasil<br><br><br></h1></div>
                    <div class="col-sm-1"></div>
                </div>
            </div>
            <br><br>
