        ...
        <div id="content">
            ...
            <div id="corpo" class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <br><h6><?= $nome ?></h6><br>
                        <h6>1)  <?php if($r1 == 1) echo 'Certo'; else echo 'Errado'; ?> </h6>
                        <h6>2)  <?php if($r2 == 1) echo 'Certo'; else echo 'Errado'; ?> </h6>
                        <h6>3)  <?php if($r3 == 1) echo 'Certo'; else echo 'Errado'; ?> </h6>
                        <h6>4)  <?php if($r4 == 1) echo 'Certo'; else echo 'Errado'; ?> </h6>
                        <h6>5)  <?php if($r5 == 1) echo 'Certo'; else echo 'Errado'; ?> </h6><br>
                    </div>
                </div>
            </div>
            <br><br>
