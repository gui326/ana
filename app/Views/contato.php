        ...
        <div class="collapse navbar-collapse" id="exCollapsingNavbar">
            ...
            <div id="corpo2" class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-2"><h1><br><br><br>Contato</h1></div>
                    <div class="col-sm-1"></div>
                    <div class="col-sm-7"><h5><br><br><br><br><br><br><br><br><br>Telefone de Contato: (16)3453-1111. <br>Nossa Localização: Rua Machado Batista, 153, Bairro Silva, Cidade Pirapitinga-SP<br><br><br><br><br><br><br><br><br><br><br></h5></div>
                    <div class="col-sm-1"></div>
                </div>
            </div>
            <br><br>
