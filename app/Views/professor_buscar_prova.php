            ...
            <div id="corpo" class="container-fluid">
                <div class="row">
                    ...
                    <?php foreach($provas as $prova): ?>
                        ...
                        <td><?php if($prova['tipo'] == 1) echo 'Matemática';
                            if($prova['tipo'] == 2) echo 'Português';
                            if($prova['tipo'] == 3) echo 'História';
                            if($prova['tipo'] == 4) echo 'Geografia';
                            if($prova['tipo'] == 5) echo 'Ciência';?></td>
                        <td><?= anchor("public/professor/mostrar_prova/$prova[ID]", 'Atualizar') ?></td>
                        </tr>
                    <?php endforeach; ?>
                    </table>
                    </div>
